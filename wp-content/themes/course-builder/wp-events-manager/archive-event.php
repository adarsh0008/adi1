        ...
        <ul class="nav nav-tabs clearfix" role="tablist">
                ...
                <li>
                    <a class="active" href="#tab-happening" data-toggle="tab"
                       data-tab="happening" role="tab"><i class="fa fa-calendar-check-o"></i><?php esc_html_e('Happening', 'course-builder'); ?></a>
                </li>

                <li>
                    <a  href="#tab-upcoming" data-toggle="tab" data-tab="upcoming"
                       role="tab"><i class="fa fa-calendar-plus-o "></i><?php esc_html_e('Upcoming', 'course-builder'); ?></a>
                </li>

                <li>
                    <a href="#tab-expired" data-toggle="tab" data-tab="expired"
                       role="tab"><i class="fa fa-calendar-times-o"></i><?php esc_html_e('Expired', 'course-builder'); ?></a>
                </li>
        </ul>

        <div class="grid-list-switch display-layout <?php echo esc_attr( $has_param ); ?>" data-cookie="event-switch" data-layout="<?php echo esc_attr( $events_layout ); ?>">
