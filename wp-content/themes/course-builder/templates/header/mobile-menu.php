...
<div class="inner-off-canvas">
	<div class="menu-mobile-effect navbar-toggle" data-effect="mobile-effect">
		...
		if ( is_user_logged_in() ) {
			...
			$html         .= '<div class="thim-link-login"><a href="' . esc_url( $register_url ) . '" class="register">' . esc_html__( 'Register', 'course-builder' ) . '</a> ' . '/' . ' <a href="' . esc_url( $login_url ) . '" class="login">' . esc_html__( 'Login', 'course-builder' ) . '</a></div>';
		}
		echo $html;
		?>
	</span>
